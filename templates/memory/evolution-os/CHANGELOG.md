...
- Optional OpenClaw typed lifecycle hooks in the plugin scaffold: `before_prompt_build` for bounded prepare context and `agent_end` for post-turn reflection, both disabled by default.
